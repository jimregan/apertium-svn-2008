...
més lemes de la llengua meta existeix una diferència de significat,
...
de codificar entrades amb múltiples equivalents és la primera, és a dir, escollint
una única traducció i marcant la resta d'equivalències amb una restricció de direcció.
En cas que utilitzem diccionaris bilingües amb aquests dos tipus d'entrades
en un sistema que no disposa de mòdul de selecció lèxica, un full d'estil
s'encarrega de convertir les entrades amb atributs \texttt{slr} o \texttt{srl}
pensats per al mòdul de selecció lèxica en entrades amb restriccions de direcció \texttt{LR} o \texttt{RL},
