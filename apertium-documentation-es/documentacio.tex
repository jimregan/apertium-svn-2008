...
El significado de los diferents símbolos es el siguiente:
...
\item \verb!#! = El problema se ha producido en el generador, que no puede
  generar la forma léxica (el diccionario morfológico no la contiene
...
Los tres parámetros que pueden utilitzarse son los siguientes:
...
conveniente utilizar una u otra opción. La primera opción és la más
adecuada cuando no se desea que signos ajenos al texto interfieren en
la lectura de la traducción. La segunda opción és útil cuando el usuario
...
opción es ideal para desarrolladores lingüísticos, puesto que muestra toda la información
lingüística de las formas léxicas que han sufrido errores.
...
se puede enviar texto a través de uno o varios módulos para analizar
su salida y detectar el motivo del error. A continuación se explica
