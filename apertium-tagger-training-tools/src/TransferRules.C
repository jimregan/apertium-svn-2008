...
bool 
TransferRules::match_regular_expression(string s, int pos_regex) {
...
void
TransferRules::set_superficial_forms(string s) {
  superficial_forms=Utils::split_string(s,"|");
