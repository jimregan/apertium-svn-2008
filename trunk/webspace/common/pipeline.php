...
function process_form() {
	...
	$trad = translate($text, $dir1, $dir2, $dir3, $markUnknown);
...
print<<<_HTML_
<form class="translation" action="$_SERVER[PHP_SELF]?id=pipeline" method="post">

<fieldset>
	<legend></legend>
		<label for="direction1">A -> B
...
/*
  **************************
	...
	**************************
*/
function translate2($text, $dir1, $dir2, $markUnknown) {
