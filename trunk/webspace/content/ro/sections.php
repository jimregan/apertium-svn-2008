<?php
	...
	$text = array("ce este Apertium?", "cine elaborează Apertium?", "descărcări", "testaţi", "documentaţie", "interactionaţi!", "ultimele noutăţi", "programe complementare", "finanţare", "utilizatori", "contact");
