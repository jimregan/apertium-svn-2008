<?php
	...
	$text = array("que &eacute; Apertium?", "quem o est&aacute; a desenvolver?", "descargas", "prove-o", "documenta&ccedil;&atilde;o", "interact! (en)", "latest news (en)", "software (en)", "funding (en)", "users (en)", "contact (en)");
